...
//		    $stroke = '{"login":"'.$login.'","access":0,"answer":"noUser","txtMsg":"Ошибка в логине или пароле. Повторите ввод данных!"}';
			echo 'Произошла ошибка в логине. Уточните у получателя логин в системе <b>НайдиВремя!</b> и попробуйте еще раз. ';
	   }
}   
