    ...
    if (strUrl.indexOf('invite=') != -1) {
        ...
        fetch('https://settime.online/php/lload.php', {
            ...
            text => {
                ...
                document.getElementById("saveDataUser").style.display = "none";
                //			alert(document.getElementById("loginSendTimeCode").value)
                document.getElementById("YourName").value = userName;
                document.getElementById("loginSendTimeCode").value = url.searchParams.get("viewBusy");
...
document.getElementById("param1Name").addEventListener('change', () => {
    localStorage.setItem('param1Name', document.getElementById("param1Name").value)
    document.getElementsByName("Level1")[0].innerHTML = param1Name.value + ":"
})

document.getElementById("param2Name").addEventListener('change', () => {
    localStorage.setItem('param2Name', document.getElementById("param2Name").value)
...
window.onload = () => {
    start();
    let twoLoad = setTimeout(start, 1800)
...
//    ).then(
//        text => {
//            sessionStorage.setItem('filteredUsers', text);
//
//
//        }
//    );
...
//    //	if (event.key != 'filteredUsers') return;
//    console.log(e.key + ': new' + e.newValue + ': old' + e.oldValue + " at " + e.url);
//    alert(e.key + ': new' + e.newValue + ': old' + e.oldValue + " at " + e.url);
//})
